...
<section style ="background-color:lightblue" id="deal" class="padding_bottom_half padding_top">
  ...
  <div class="form-row">
    ...
    <textarea name="message" class="mb-2 form-control" id="message"  rows="12" placeholder="Message"></textarea>
    <br>
    <button id="submit" type="submit" class="btn btn-primary mt-2 pt-3">Submit</button>
     </div>
