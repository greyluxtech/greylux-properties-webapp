         ...
         <ul>
             ...
             <div class="tp-static-layers">
                 <div class="tp-caption tp-static-layer" id="slide-37-layer-2" data-x="['left','left','left','left']"
                     ...
                     data-margintop="[2, 2, 2, 2]"  data-margintop="['20','20','20','20']"
                     data-visibility="['on','on','on','on']" data-fontsize="['24', '24', '22', '18']" data-start="500"
                 ...
                 <div class="tp-caption tp-static-layer" id="slide-37-layer-2" data-x="['left','left','left','left']"
                     data-hoffset="['60','60','50','50']" data-y="['bottom','bottom','bottom','bottom']"
                     ...
                     <p class="t_white m-3 p-3">We Deal with Different kinds of Properties No matter you need a House,
                 ...
                 <div class="tp-caption tp-static-layer" id="slide-37-layer-2" data-x="['left','left','left','left']"
                     ...
                     data-startslide="0" data-endslide="5" style="z-index: 5;"><a href="listing1.html"
                         class="btn-white border_radius uppercase m-3 p-3">view Properties</a>
                 </div>
             </div>
         </ul>
     </div>
...
<section id="property" class="padding_top padding_bottom_half">
  ...
  <div class="col-md-4">
    <div class="thumbnail">
        ...
        <a class="btn btn-primary stretched-link" href="{{route('displayResultDetails', $property->id)}}"> View Property</a>
        </div>
    </div>
  </div>
  @endforeach
