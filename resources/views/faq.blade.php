    	...
    	<div class="row">
        	<div class="col-sm-6">
            	<div class="faq-text margin40">
                    <h5><strong>Q: Suspendisse eleifend massa commodo porta lacus bibendum?</strong></h5>
                    <p class="top15">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras et dui vestibulum, bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus. Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. Aliquam posuere fermentum lorem, a aliquam mauris rutrum a. Curabitur sit amet pretium lectus, nec consequat orci.</p>
                    <p class="top30">Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Duis et metus in libero sollicitudin venenatis eu sed enim. Nam felis lorem, suscipit ac nisl ac, iaculis dapibus tellus. Cras ante justo, aliquet quis placerat nec, molestie id turpis.</p>
            	</div>
                <div class="faq-text margin40">
                    <h5><strong>Q:  sodales tellus non, gravida turpis?</strong></h5>
                    <p class="top15">Bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus.</p>
                     <p class="top30">Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
            	</div>
                <div class="faq-text margin40">
                    <h5><strong>Q:  massa commodo porta lacus bibendum?</strong></h5>
                    <p class="top15">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras et dui vestibulum, bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus. Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
            	</div>
                <div class="faq-text margin40">
                    <h5><strong>Q:  massa commodo porta lacus bibendum?</strong></h5>
                    <p class="top15">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras et dui vestibulum, bibendum purus sit amet, vulputate mauris.</p>
                    <p class="top30">Ut adipiscing gravida tincidunt.</p>
            	</div>
            </div>
            
            <div class="col-sm-6">
            	<div class="faq-text margin40">
                    <h5><strong>Q: Aliquam eget quam iaculis.</strong></h5>
                    <p class="top15">Bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus. Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
            	</div>
                <div class="faq-text margin40">
                    <h5><strong>Q:  sodales tellus non, gravida turpis?</strong></h5>
                    <p class="top15">Bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus. Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris.</p>
                ...
                <div class="faq-text margin40">
                    <h5><strong>Q:  Suspendisse eleifend tellus non, gravida turpis.</strong></h5>
                    <p class="top15">Bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus. Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
                     <p class="top30">Bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus. Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
            	</div>
                <div class="faq-text margin40">
                    <h5><strong>Q:  sodales tellus non, gravida turpis?</strong></h5>
                    <p class="top15">Bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus. Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
                    <p class="top30">Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
                    <p class="top30">vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus. Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
            	</div>
            </div>
        </div>
    </div>
